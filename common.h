...
#define NO_OF_PARTICLES_IN_BDCELL 60
...
real minRotEdgeLength, maxRotEdgeLength;
real prevCPUTime;
...
int maxFaces, maxRotFaces, nFace, faceType; //temp value
int *walls;
...
real wBoxDx, wBoxDy, wBoxDz; //wall grid cell size 
...
void readInput(char *infile, int *np, real *dens, real *ymod, 
			...
			real *cyldia, real *dt, int *nW, int *updateDPM, real *maxVel, int *rotZoneID);
